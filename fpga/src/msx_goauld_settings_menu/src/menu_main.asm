...
.printmenu_loop_end:
	...
	ld   b, a
	ld   a, 1						; Bit 0: mapper enable, siempre activo
	ld   (var_mapper), a
	ld   a, b
	and  #02						; Bit 1: megaram enable
	rrca
	ld   (var_megram), a
	ld   a, b						; Bit 2: ghost scc, retirado (siempre 0)
...
selected_mapper:
	ret								; El mapper esta siempre activo, no se conmuta
...
config_var2byte:
	ld   a, 1						; #41 Bit 0: mapper enable, siempre a 1
	ld   b, a
	ld   a, (var_megram)			; #41 Bit 1: megaram enable
	rlca
	or   b
	ld   b, a
									; #41 Bit 2: ghost scc, retirado -> queda a 0
...
struct_EnableScanlines:
	...
	.dw struct_EnableSD, struct_Turbo, struct_EnableScanlines
	.dw #0800 + POS_Y*10 + 2
	.db 4
